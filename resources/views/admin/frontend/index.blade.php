...
<style>
    ...
    .bgimg {background-image: url("/image/background.jpg")}
    .bgimg2 {background-image: url("https://drive.google.com/drive/u/0/folders/1oqvW66-I6u0urzYgthUEIKUXeB-4CLeV")}
</style>
<body>
...
{{--        <img src="http://localhost:8000/image/background.jpg" width="300px">--}}
        <div class="banner-bride-name" style="color: deeppink">
            <h1> Sherlly Enterprise </h1>
        </div>
    </div>
</header>
...
<div class="w3-top w3-hide-small">
    <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
        ...
        <a href="#us" style="width:25%" class="w3-bar-item w3-button">Galery</a>
        <a href="#wedding" style="width:25%" class="w3-bar-item w3-button">Wedding</a>
        <a href="#rsvp" style="width:25%" class="w3-bar-item w3-button w3-hover-black">Contact</a>
    </div>
</div>
